...
mutual
  ...
  top     ≃ top     = top
  univ α  ≃ univ β  = α ≟ₙ β
  σ A₁ B₁ ≃ σ A₂ B₂ = σ (A₁ ≃ A₂) λ P -> π _ λ x₁ -> π _ λ x₂ -> π (x₁ ≅ x₂) λ _ -> B₁ x₁ ≃ B₂ x₂
  π A₁ B₁ ≃ π A₂ B₂ = σ (A₂ ≃ A₁) λ P -> π _ λ x₁ -> π _ λ x₂ -> π (x₂ ≅ x₁) λ _ -> B₁ x₁ ≃ B₂ x₂
  _       ≃ _       = bot
  ...
  _≅_ {A = σ A₁ B₁} {σ A₂ B₂} p₁ p₂ = let (x₁ , y₁) , (x₂ , y₂) = p₁ , p₂ in
    σ (x₁ ≅ x₂) λ _ -> y₁ ≅ y₂
  _≅_ {A = π A₁ B₁} {π A₂ B₂} f₁ f₂ = π _ λ x₁ -> π _ λ x₂ -> π (x₁ ≅ x₂) λ _ -> f₁ x₁ ≅ f₂ x₂
  x ≅ y = bot 
